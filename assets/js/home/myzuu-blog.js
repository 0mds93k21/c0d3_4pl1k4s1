    ...
    bar += '<div class="card-blog">';
        ...
        bar += '<div class="card-body-blog">';
            bar += '<a href="https://myzuu.webtoko.net/digital/194780">';
                bar += '<img src="/assets/img/home/blog/1.png" alt="Myzuu" class="img-card-myzuu" />';
        ...
        bar += '<div class="card-body-blog">';
            bar += '<a href="https://myzuu.webtoko.net/pages?voucher">';
                bar += '<img src="/assets/img/home/blog/2.png" alt="Myzuu" class="img-card-myzuu" />';
                bar += '<div class="text-card-blog">';
        ...
        bar += '<div class="card-body-blog">';
            bar += '<a href="https://help.myzuu.my.id/blog/67556063/">';
                bar += '<img src="/assets/img/home/blog/3.png" alt="Myzuu" class="img-card-myzuu" />';
                bar += '<div class="text-card-blog">';
